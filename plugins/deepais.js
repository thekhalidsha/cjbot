...
Asena.addCommand({pattern: 'deepaii', fromMe: true, dontAddCommandList: false, deleteCommand: false, desc: Lang.DEEPAIS_DESC}, (async (message, match) => {
...
Asena.addCommand({pattern: 'colorai', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    ffmpeg(location)
        ...
        .on('end', async () => {
            ...
            await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made by CJ BOT'})
...
Asena.addCommand({pattern: 'waifuai', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
...
Asena.addCommand({pattern: 'superai', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
...
Asena.addCommand({pattern: 'moodai ?(.*)', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'dreamai', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
...
Asena.addCommand({pattern: 'neuraltalkai', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
...
Asena.addCommand({pattern: 'ttiai ?(.*)', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') return await message.sendMessage(Lang.TEXT);
...
Asena.addCommand({pattern: 'toonai', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
...
Asena.addCommand({pattern: 'nudityai', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');
...
Asena.addCommand({pattern: 'textai ?(.*)', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') return await message.sendMessage(Lang.TEXT);
...
Asena.addCommand({pattern: 'ganstyle', fromMe: false, dontAddCommandList: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('```Need Photo!```');

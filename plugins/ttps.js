...
Asena.addCommand({pattern: 'ttp ?(.*)', fromMe: false, dontAddCommandList: true, desc: Lang.TTP_DESC}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(ttinullimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '_*CJ BOT*_'})

...
Asena.addCommand({pattern: 'wallpaper', fromMe: false, dontAddCommandList: true, desc: Lang.WP}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'CJ BOT'})

...
Asena.addCommand({pattern: 'mp4audio', fromMe: false, dontAddCommandList: true, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
...
Asena.addCommand({pattern: 'imagesticker', fromMe: false, dontAddCommandList: true, desc: Lang.STİCKER_DESC}, (async (message, match) => {    
